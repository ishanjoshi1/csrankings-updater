...
def main() -> None:
    ...
    # missing_label = Label(main_frame, text="Missing Faculty on CSRankings", width=100, font=("Arial", 12), borderwidth=1, relief="solid", pady=20)
    missing_label = Label(
        main_frame,
    ...
    missing_label.grid(row=0, column=0, columnspan=3)
    ...
    # add_header.grid(row=1, column=2)
    add_header.grid(row=1, column=1)
    ...
    for i, faculty in enumerate(faculty_on_website, start=2):
        if not any(
            ...
            missing_website = Label(
                main_frame,
                text=faculty_on_website[faculty]["website"],
                width=50,
                font=("Arial, 10"),
                borderwidth=1,
                relief="solid",
            ...
            add_checkbutton = Checkbutton(checkbutton_label, text="")
            add_checkbutton.pack()

            missing_name.grid(row=i, column=0)
            # missing_website.grid(row=i, column=1)
            # checkbutton_label.grid(row=i, column=2)
            checkbutton_label.grid(row=i, column=1)

    # extra_label = Label(main_frame, text="Extra Faculty on CSRankings", width=100, font=("Arial", 12), borderwidth=1, relief="solid", pady=20)
    extra_label = Label(
        main_frame,
    ...
    extra_label.grid(row=i + 1, column=0, columnspan=3)
    ...
    extra_add_header.grid(row=i + 2, column=1)
    ...
    for j, faculty in enumerate(faculty_on_csrankings, start=i + 3):
        if not any(
            ...
            extra_checkbutton_label.grid(row=j, column=1)
